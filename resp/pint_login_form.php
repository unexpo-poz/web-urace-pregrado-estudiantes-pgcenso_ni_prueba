...
if ($inscHabilitada){
	...
	print <<<x001
		...
		Disculpe, el proceso no est&aacute; habilitado. 
		</font>
x001
;
}
...
?>		  </p>
  ...
  <tr>
	<td align="center">
		...
		ATENCIÓN: Si posee asignaci&oacute;n por CNU ser&aacute; rechazado autom&aacute;ticamente.</span><br>
	</td>
  </tr>
...
favor escribe tus datos y el c&oacute;digo de seguridad, luego pulsa el bot&oacute;n "Entrar" para
          poder acceder al Censo</font></td>
   </tr>
  <tr>
      ...
      <form method="post" name="chequeo" onsubmit="return validar(this)" 
		...
		Primer Apellido:&nbsp;<input name="contra_v" size="20" tabindex="2" type="text">&nbsp;&nbsp;  
    ...
    <tr>
      <td class ="instruc"><b>NOTAS:</b>
		<ul style="list-style-type: square;">
			<li>Para ingresar al sistema de Censo debes introducir los datos tal y como se muestran en la lista de alumnos asignados.</li>
			...
			<li>Solo puedes dejar en blanco los campos correspondientes a "Direcci&oacute;n de Residencia" si &eacute;sta es igual a tu direcci&oacute;n permanente (de tu hogar). Estos datos son muy importantes en caso de emergencias.</li>			
        </ul>
	  </td>
    </tr>
  </tbody>
