...
<input type="hidden" name="dirp_e_S_1" value="<?php echo $estado; ?>">
<input type="hidden" name=""hidden_parroq_residencia"" value="<?php echo $tot_prom_nts; ?>">

<select name="proc_eS" id="proc_e_S_1" class="datospf" onChange="parroquia_resi(dirp_e_S_1.value, this.value, tot_prom_nts.value, estadoBD.value);">
